...
VALUES
    ...
    ('c1f40bb1900', 'maria.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2023LT044', 'María', 'Gómez', '1º Bachillerato', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('a1b2c3d4e5f', 'ana.lopez.loantech@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2016LT101', 'Ana', 'López', '3º ESO', 'Laura Vidal', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ...
    ('9z8y7x6w5v4', 'msanz.loantech@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2015LT404', 'Martín', 'Sanz', '1º Bachillerato', 'María Gómez', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('fedcba98765', 'lvidal.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2020LTP01', 'Laura', 'Vidal', '3º ESO', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('54321abcde', 'pramos.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2019LTP02', 'Pedro', 'Ramos', '1º ESO', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('1a2b3c4d5e6', 'ediaz.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2021LTP03', 'Elena', 'Díaz', 'FP Grado Medio', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('0d6d031ad0a', 'admin.loantech.admin@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ADMIN', '2010LT295', 'Admin', 'User', NULL, NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
