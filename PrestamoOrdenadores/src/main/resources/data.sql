...
VALUES
    ...
    ('fedcba98765', 'laura.vidal.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2020LTP01', 'Laura', 'Vidal', '2º Bachillerato', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('54321abcde', 'pedro.ramos.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2019LTP02', 'Pedro', 'Ramos', '1º ESO, 3º ESO', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('1a2b3c4d5e6', 'elena.diaz.loantech.profesor@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2021LTP03', 'Elena', 'Díaz', 'FP Grado Medio', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('0d6d031ad0a', 'admin.loantech.admin@gmail.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ADMIN', '2010LT295', 'Admin', 'User', NULL, NULL, '/assets/avatars/avatarRatonHada.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
