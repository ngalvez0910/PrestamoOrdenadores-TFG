...
VALUES
    ('3854b5ba26c', 'juan@loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2015LT849', 'Juan', 'Pérez', '1º Bachillerato', 'María Gómez', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('c1f40bb1900', 'maria@profesor.loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2023LT044', 'María', 'Gómez', '1º Bachillerato', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('a1b2c3d4e5f', 'ana.lopez@loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2016LT101', 'Ana', 'López', '2º Bachillerato', 'Laura Vidal', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('f5e4d3c2b1a', 'david.garcia@loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2017LT202', 'David', 'García', '1º ESO', 'Pedro Ramos', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('abcdef12345', 'sofia.rodriguez@loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2018LT303', 'Sofía', 'Rodríguez', '3º ESO', 'Laura Vidal', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('9z8y7x6w5v4', 'martin.sanz@loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ALUMNO', '2015LT404', 'Martín', 'Sanz', '1º Bachillerato', 'María Gómez', '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('fedcba98765', 'laura.vidal@profesor.loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2020LTP01', 'Laura', 'Vidal', '2º Bachillerato', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('54321abcde', 'pedro.ramos@profesor.loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2019LTP02', 'Pedro', 'Ramos', '1º ESO, 3º ESO', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('1a2b3c4d5e6', 'elena.diaz@profesor.loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'PROFESOR', '2021LTP03', 'Elena', 'Díaz', 'FP Grado Medio', NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
    ('0d6d031ad0a', 'admin@admin.loantech.com', '$2a$12$pwhykP.03H8de9whL58AzO2ZpuxZoS1O1KSGesjW..zndYFxu0wB2', 'ADMIN', '2010LT295', 'Admin', 'User', NULL, NULL, '/assets/avatars/avatarAzul.png', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false),
