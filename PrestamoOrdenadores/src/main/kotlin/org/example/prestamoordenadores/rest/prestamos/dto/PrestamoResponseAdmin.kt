...
/**
 * Clase de datos (Data Class) que representa la respuesta detallada de un préstamo para administradores.
 ...
 * @property createdDate La fecha de creación del préstamo en formato de cadena.
 * @property updatedDate La fecha de la última actualización del préstamo en formato de cadena.
 * @property isDeleted Indica si el préstamo ha sido marcado para eliminación lógica.
